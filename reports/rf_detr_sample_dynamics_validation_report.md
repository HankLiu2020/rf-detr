...
本分支在官方 `develop` 基线 `c107a748bbf369ad455cd41d85b9c91a5a0ecbad` 上实现了 RF1–RF8 的可选路径，并为 RF-DETR Seg Small 提供了可复现配置和 smoke 脚本。默认配置保持关闭，因此默认 loss、matcher、optimizer、DataLoader 行为不变。
